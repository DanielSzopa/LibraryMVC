...
{
    public partial class RemoveManyToManyAuthorBook : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfAccommodation = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<int>(type: "int", nullable: false),
                    ReservationOrRental = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerContactDetailId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelephoneNumbers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TelephoneNumbers_CustomerContactDetails_CustomerContactDetailId",
                        column: x => x.CustomerContactDetailId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TelephoneNumbers_CustomerContactDetailId",
                table: "TelephoneNumbers",
                column: "CustomerContactDetailId");
        }
